const layouts = {
    default: {
        ...
        structure: template => {
            return `<div class="container">
                ...
                <p>- ${template.author === 'Unknown' ? 'Anonymous' : template.author} </p>
            </div>`
        },
    },
    socrates: {
        style: template => {
            const borderColor = template.theme.bg_color === 'fffefe' ? 'ccc' : template.theme.bg_color
        ...
        structure: template => {
            return `<div class="square-brackets-quote">
                        <blockquote>
                            <p>${template.quote}</p>
                            <cite>${template.author === 'Unknown' ? 'Anonymous' : template.author}</cite>
                        </blockquote>
                    </div>`
        },
    },
    churchill: {
        ...
        structure: template => {
            return `<div id="ct">
                  ...
                  <span>${template.author === 'Unknown' ? 'Anonymous' : template.author}</span>
                  <blockquote>
    ...
    samuel: {
        style: template => {
            const borderColor = template.theme.bg_color === 'fffefe' ? '757575' : template.theme.bg_color
            return `.quote {
                  display: inline-block;
                  margin: 1em;
                  width:600px;
    ...
    zues: {
        ...
        <div class="container">
            <div class="quote4">
                  ...
                  <div class="from">${template.author === 'Unknown' ? 'Anonymous' : template.author}</div>
            </div>
        </div>
        `
        },
...
export const getLayout = (value: string): any => {
    return layouts[value] ? layouts[value] : layouts['default']
}
